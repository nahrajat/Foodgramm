...
const CreateFood = () => {
    ...
    const onSubmit = async (e) => {
        ...
        navigate("/homepage"); // Redirect to home or another page after successful creation
        // Optionally reset
        ...
        <div className="create-food-page">
            <div className="create-food-card">
                ...
                <form className="create-food-form" onSubmit={onSubmit}>
                    ...
                    <div className="field-group">
                        <label htmlFor="redirectLink">Direct Link</label>
                        <input
                            id="redirectLink"
                            type="url"
                            placeholder="e.g., https://yourstore.com/menu/item"
                            value={redirectLink}
